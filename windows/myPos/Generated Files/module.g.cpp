...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"myPos.MainPage"))
    {
        return winrt_make_myPos_MainPage();
    }

    if (requal(name, L"myPos.XamlMetaDataProvider"))
    {
        return winrt_make_myPos_XamlMetaDataProvider();
    }
