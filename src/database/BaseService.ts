...
export class BaseService {
  ...
  setPrimaryKeyFields(fields: string[]): this {
    console.log(
      `[BaseService][setPrimaryKeyFields] Setting primary key fields for schema: ${
        this.schemaName
  ...
  protected buildSelectTable(
    ...
    console.log(
      `[BaseService][buildSelectTable] Building select query for schema: ${
        this.schemaName
  ...
  protected buildDataTable(data: Record<string, any>): QueryTable {
    console.log(
      `[BaseService][buildDataTable] Building data table for schema: ${
        this.schemaName
  ...
  async findAll(
    ...
    console.log(
      `[BaseService][findAll] Finding all records for schema: ${
        this.schemaName
      }, conditions: ${JSON.stringify(conditions)}, options: ${JSON.stringify(
        options,
      )}`,
  ...
  async findFirst(conditions: Record<string, any> = {}): Promise<any> {
    console.log(
      `[BaseService][findFirst] Finding first record for schema: ${
        this.schemaName
  ...
  async create(data: Record<string, any>): Promise<any> {
    console.log(
      `[BaseService][create] Creating record for schema: ${
        this.schemaName
      }, data: ${JSON.stringify(data)}`,
    );
    await this._ensureInitialized();
  ...
  async update(
    ...
    console.log(
      `[BaseService][update] Updating record with ID: ${id} for schema: ${
        this.schemaName
      }, data: ${JSON.stringify(data)}`,
    );
    await this._ensureInitialized();
  ...
  async count(conditions: Record<string, any> = {}): Promise<number> {
    console.log(
      `[BaseService][count] Counting records for schema: ${
        this.schemaName
      }, conditions: ${JSON.stringify(conditions)}`,
    );
    await this._ensureInitialized();
  ...
  protected _validateData(data: any): void {
    console.log(
      `[BaseService][_validateData] Validating data for schema: ${
        this.schemaName
      }, data: ${JSON.stringify(data)}`,
    );
